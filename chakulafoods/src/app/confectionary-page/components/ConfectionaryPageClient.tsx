...
import { Calendar, ShoppingCart, Star, Clock, Gift, Repeat, Cake } from 'lucide-react';
...
// Backend integration point: replace with GET /api/products?department=confectionary
const confectionaryItems = [
{ id: 'conf-001', name: 'Classic Vanilla Birthday Cake (1kg)', category: 'Cakes', price: 65000, rating: 4.9, leadTime: '24h notice', image: "https://images.unsplash.com/photo-1583834096166-540450cbc928", tag: 'Bestseller', schedulable: true, description: 'Light vanilla sponge with buttercream frosting, custom message included' },
...
{ id: 'conf-004', name: 'Birthday Deluxe Package', category: 'Birthday Packages', price: 185000, rating: 5.0, leadTime: '48h notice', image: "https://images.unsplash.com/photo-1708707048055-a3f3691b25f6", tag: 'Complete Package', schedulable: true, description: '2kg cake + 12 cupcakes + 20 cake pops + personalized decoration & candles' },
...
{ id: 'conf-006', name: 'Corporate Event Package', category: 'Birthday Packages', price: 350000, rating: 4.8, leadTime: '72h notice', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1fa6bbfa6-1779098361392.png", tag: 'Corporate', schedulable: true, description: '3kg cake + 50 mini pastries + branded packaging for events of 30+ people' },
{ id: 'conf-007', name: 'Cinnamon Croissants (6 pack)', category: 'Pastries', price: 22000, rating: 4.6, leadTime: '3h notice', image: "https://images.unsplash.com/photo-1591521771366-061035830132", tag: 'Fresh Baked', schedulable: false, description: 'Flaky, buttery croissants with cinnamon filling, baked fresh daily' },
...
{ id: 'conf-010', name: 'Chocolate Brownie Dessert Box', category: 'Dessert Boxes', price: 28000, rating: 4.7, leadTime: '2h notice', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1ec14b095-1779098360710.png", tag: 'Indulgent', schedulable: true, description: 'Box of 9 fudgy brownies — plain, walnut, and caramel swirl' },
...
{ id: 'conf-012', name: 'Weekly Dessert Pack Subscription', category: 'Dessert Boxes', price: 95000, rating: 4.8, leadTime: 'Weekly', image: "https://img.rocket.new/generatedImages/rocket_gen_img_18dc0cef0-1776505846126.png", tag: 'Subscribe & Save', schedulable: true, description: 'Fresh dessert box every week — curated selection, 10% off vs individual orders' }];
        ...
        <div key={item.id} className="card-base overflow-hidden card-hover flex flex-col group">
            ...
            <div className="p-4 flex flex-col flex-1">
              ...
              <div className="flex gap-2">
                ...
                addingId === item.id ?
                'bg-secondary/20 text-secondary cursor-not-allowed' : 'bg-secondary/10 text-secondary hover:bg-secondary hover:text-secondary-foreground'}`
                }>
              ...
              <button
                ...
                className="p-2 rounded-lg border border-border hover:border-secondary hover:bg-secondary/5 transition-all duration-150"
