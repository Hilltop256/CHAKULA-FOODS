      ...
      try {
        ...
        const message =
          err instanceof Error
            ? err.message
            : "Failed to load confectionary products";
        setError(message);
      } finally {
        setLoading(false);
      }
      ...
      <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10 py-8">
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-xl font-bold text-foreground mb-2">
            Failed to load confectionary menu
          </h2>
    ...
    <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Custom cakes, birthday packages, fresh pastries and curated dessert
          boxes
        </p>
      </div>
      ...
      <div className="relative overflow-hidden rounded-2xl mb-8 bg-gradient-to-r from-secondary to-amber-400 p-6 text-white">
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm mb-4">
            Complete packages with custom cake, cupcakes, decorations and
            delivery.
          </p>
          <button
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">
                {subscriptionItem.description ||
                  "Fresh curated dessert box every week — subscribe and save!"}
              </p>
            </div>
          </div>
          <button
      ...
      <div className="flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-6">
        ...
        <p className="text-xs text-amber-800 font-medium">
          Cakes and birthday packages require advance notice. Use the calendar
          icon to schedule your order timing.
        </p>
      </div>
              ...
              {item.tag && (
                <span
                  className={`absolute top-2 left-2 text-xs font-semibold px-2 py-0.5 rounded-full ${
                    item.tag === "Bestseller" || item.tag === "Popular"
                      ? "bg-secondary text-secondary-foreground"
                      : item.tag === "Complete Package" ||
                          item.tag === "Subscribe & Save"
