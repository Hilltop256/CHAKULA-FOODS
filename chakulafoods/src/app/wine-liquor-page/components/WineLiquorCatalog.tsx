...
import { Star, MapPin, Clock, AlertTriangle, Wine, Plus } from 'lucide-react';
...
const wineItems = [
{ id: 'wl-001', name: 'Nederburg Cabernet Sauvignon', category: 'Wines', price: 65000, rating: 4.7, origin: 'South Africa', volume: '750ml', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1e1ee595d-1781774211966.png", tag: 'Popular', inStock: true, description: 'Bold red wine with dark fruit flavors and a long, smooth finish' },
...
{ id: 'wl-011', name: 'Konyagi (Uganda Gin)', category: 'Whiskey', price: 35000, rating: 4.3, origin: 'Uganda', volume: '750ml', image: "https://img.rocket.new/generatedImages/rocket_gen_img_15b39e941-1779095228542.png", tag: 'Local', inStock: true, description: "Uganda's most popular spirit — smooth gin with a clean, refreshing taste" },
{ id: 'wl-012', name: 'Wine Lovers Trio Pack', category: 'Party Bundles', price: 175000, originalPrice: 210000, rating: 4.7, origin: 'Mixed', volume: '3 × 750ml', image: "https://images.unsplash.com/photo-1612509564039-c96c8f169a80", tag: 'Gift Pack', inStock: false, description: 'Red, white and rosé — a curated trio for wine enthusiasts, gift-wrapped' }];
