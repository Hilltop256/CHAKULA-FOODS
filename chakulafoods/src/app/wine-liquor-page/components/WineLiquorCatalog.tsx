...
const wineItems = [
{ id: 'wl-001', name: 'Nederburg Cabernet Sauvignon', category: 'Wines', price: 65000, rating: 4.7, origin: 'South Africa', volume: '750ml', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1412d9055-1779613294114.png", tag: 'Popular', inStock: true, description: 'Bold red wine with dark fruit flavors and a long, smooth finish' },
...
{ id: 'wl-006', name: 'Jameson Irish Whiskey', category: 'Whiskey', price: 118000, rating: 4.7, origin: 'Ireland', volume: '700ml', image: "https://img.rocket.new/generatedImages/rocket_gen_img_148b6bf5d-1779095229808.png", tag: 'Irish', inStock: true, description: 'Triple-distilled Irish whiskey, famously smooth with nutty and vanilla notes' },
{ id: 'wl-007', name: 'Moët & Chandon Brut', category: 'Champagne', price: 280000, rating: 4.9, origin: 'Champagne, France', volume: '750ml', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1d2bef54b-1779613294964.png", tag: 'Luxury', inStock: true, description: 'Iconic French champagne with fine bubbles, green apple and citrus notes' },
{ id: 'wl-008', name: 'Cinzano Prosecco DOC', category: 'Champagne', price: 85000, rating: 4.5, origin: 'Veneto, Italy', volume: '750ml', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1f4b8d48c-1779613295551.png", tag: 'Prosecco', inStock: true, description: 'Italian sparkling wine, light and refreshing with pear and peach aromas' },
...
{ id: 'wl-011', name: 'Konyagi (Uganda Gin)', category: 'Whiskey', price: 35000, rating: 4.3, origin: 'Uganda', volume: '750ml', image: "https://img.rocket.new/generatedImages/rocket_gen_img_1e719cf5a-1779613297141.png", tag: 'Local', inStock: true, description: "Uganda's most popular spirit — smooth gin with a clean, refreshing taste" },
...
export default function WineLiquorCatalog() {
  ...
  const handleAddToCart = async (item: typeof wineItems[0]) => {
