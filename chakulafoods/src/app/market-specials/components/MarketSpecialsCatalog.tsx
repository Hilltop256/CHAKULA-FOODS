      ...
      <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10 py-8">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-3xl font-extrabold text-foreground">Market Specials</h1>
          </div>
          <p className="text-muted-foreground">Selected market items & special offers</p>
        </div>
    ...
    <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Selected market items & special offers — fresh and seasonal
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            type="text"
            placeholder="Search market specials..."
            value={searchQuery}
            ...
            >
              <div className="relative">
                <AppImage
                  ...
                  alt={`${product.name} — Chakula Foods Market Specials`}
                  width={300}
                  height={220}
                ...
                {product.tag && (
                  <span
                    className={`absolute top-2 left-2 text-xs font-semibold px-2 py-0.5 rounded-full ${
                      product.featured ? 'bg-secondary text-secondary-foreground' : 'bg-card text-foreground border border-border'
                    }`}
                  >
                    {product.tag}
                  </span>
